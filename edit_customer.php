...
<body>
    <form class="add_customer_form" action="edit_customer_action.php" method="post">
        ...
        <div class="flex-container">
            ...
            <div  class=container>
                <select name="branch">
                    <option value="delhi" <?php if ($branch == 'Chennai Main') {?> selected="selected" <?php }?>>Chennai Main</option>
                    <option value="newyork" <?php if ($branch == 'Pammal') {?> selected="selected" <?php }?>>Pammal</option>
                </select>
            </div>
        </div>
