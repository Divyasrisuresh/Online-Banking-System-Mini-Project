    ...
    <form class="add_customer_form" action="customer_add_action.php" method="post">
        ...
        <div class="flex-container">
            <div class=container>
                ...
                <input name="aadhar" size="16" type="text" required />
            </div>
        </div>
        ...
        <div class="flex-container">
            ...
            <div  class=container>
                ...
                <input name="phno" size="10" type="text" required />
            </div>
        </div>
        ...
        <div class="flex-container">
            ...
            <div  class=container>
                <select name="branch">
                    <option value="delhi">Chennai Main</option>
                    <option value="newyork">Pammal</option>
                </select>
            </div>
        </div>
